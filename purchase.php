...
?>
	...
	<form method="post" action="process.php" class="form-horizontal">
        ...
        <div class="form-group">
            <label for="card_number" class="col-lg-2 control-label">Número de tarjeta</label>
            <div class="col-lg-10">
	...
	<p class="lead">Presione Comprar para confirmar su compra o Continuar comprando para agregar o eliminar artículos.</p>
<?php
	} else {
		echo "<p class=\"text-warning\">¡Tu carrito esta vacío! ¡Asegúrate de agregar algun producto!</p>";
	}
